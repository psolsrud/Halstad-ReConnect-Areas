...
function serviceModel(feature) {
    ...
    //$(".title").prepend('Congratulations, You are in our area');
    $(".speed").prepend('<div class="product-content"><img src="https://static.wixstatic.com/media/aee650_a6c7b00f0c6b48089c1bede43dd9840b~mv2.png/v1/fill/w_192,h_176,al_c,q_85/thumbs--up.webp" style="vertical-align: middle;width:160px;height:160px;">' + '&nbsp;&nbsp;<span>' + feature.properties.speed + '</span></div>');
